...
impl HandType {
    fn parse(input: &str) -> HandType {
        let mut character_counts: Vec<usize> = input
            .chars()
            ...
            .into_values()
            .collect();
        character_counts.sort_unstable_by(|a, b| b.cmp(a));

        match character_counts[0] {
            5 => Self::FiveOfAKind,
            4 => Self::FourOfAKind,
            3 if character_counts[1] == 2 => Self::FullHouse,
            3 => Self::ThreeOfAKind,
            2 if character_counts[1] == 2 => Self::TwoPair,
            2 => Self::OnePair,
            _ => Self::HighCard,
        }
    }
